...
\def\AbstraktEN{%
The subject of this thesis is to create an extension for web browsers that adds new functionalities to the school information system InSIS. The purpose of these added features is to improve the productivity of system users and reduce the deficiencies in working with the system that are often mentioned by students. The aim of the thesis is to design and subsequently implement an extension for web browsers along with a supporting server for storing user data. Another goal is to compare available technologies for both parts of the software solution. The final objective is to evaluate feedback from users of the web extension to verify the established hypotheses. This feedback was obtained through a survey. The result of the thesis is a functional, coherent software solution with easy installation and distribution through the Google Web Store and Firefox Addons platforms, which currently has more than 300 installations and 100 active users.
}
