...
\todo{Limitace že Firefox nepodporuje verzi 3 a jak se to řeší}
...
\todo{Jak funguje renderování hodin, předávání eventů, Chakra UI?}
...
\todo{Odkaz na GitLab repozitář https://gitlab.com/vse-plus/extension}
