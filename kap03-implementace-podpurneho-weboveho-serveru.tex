...
Aktuální verze zdrojových kódu a historie změn pro podpůrný webový server je dostupná jako repozitář na platformě GitLab na adrese \url{https://gitlab.com/vse-plus/api}.